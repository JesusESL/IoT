                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="row justify-content-start">
                                    <div class="col-2">
                                        <a href="#Map" id="changeTemperature" onclick='changeTemperature();' class="btn btn-primary m-b-20">Temperature</a>
                                    </div>
                                    <div class="col-2">
                                        <a href="#Map" id="changeHumidity" onclick='changeHumidity();' class="btn btn-primary m-b-20">Humidity</a>
                                    </div>
                                </div>
